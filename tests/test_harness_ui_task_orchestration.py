...
def test_h5_server_uses_recovery_bff_and_serves_all_task_assets():
    ...
    tasks_source = (ROOT / "hermes_harness" / "tasks.py").read_text(encoding="utf-8")
...
def test_h5_browser_assets_have_dag_recovery_without_eventsource_or_secrets():
    source = (ROOT / "hermes_harness" / "static" / "harness-tasks.js").read_text(encoding="utf-8")
    recovery_source = (ROOT / "hermes_harness" / "static" / "harness-task-recovery.js").read_text(
        encoding="utf-8"
    )
